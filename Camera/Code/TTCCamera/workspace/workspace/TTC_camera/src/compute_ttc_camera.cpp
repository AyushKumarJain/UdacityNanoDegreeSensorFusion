                      ...
                      std::vector<cv::DMatch> kptMatches, double frameRate, double &TTC)
{
    ...
    { // outer kpt. loop
        ...
        cv::KeyPoint kpOuterCurr = kptsCurr.at(it1->trainIdx); // trainIdx is the index of the matched keypoint in the previous frame.
        cv::KeyPoint kpOuterPrev = kptsPrev.at(it1->queryIdx); // queryIdx is the index of a keypoint in the current frame.
