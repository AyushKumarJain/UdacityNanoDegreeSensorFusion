...
#include <vector>
#include <string>
// This render.h header file has functions that allow us to render points and shapes to the pcl viewer.
// For example we will be using it to render our lidar rays as line segments in the viewer.
struct Color
{
...
// The renderRays method has viewer as argument, which gets passed in by reference. 
// This means that any changes to the viewer in the body of the renderRays function directly affect the viewer outside the function scope. 
// The lidar position (const Vect3& origin)  also gets passed in, as well as the point cloud that your scan function generated. 
...
// renderPointCloud function is made to view the point cloud data 
